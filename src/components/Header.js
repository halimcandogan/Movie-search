      ...
      <div className=" bg-gradient-to-r from-sky-900 to-sky-800 p-4">
        <div className="flex max-w-6xl mx-auto justify-between items-center">
          ...
          <div className="flex space-x-4">
            <ul className="flex space-x-8 bg-white  px-4 py-1 rounded-full  drop-shadow-lg">
              <Link to={"/"}>
                <li>İzlenecekler</li>
              </Link>
              <Link to={"/watched"}>
            ...
            <Link to={"/add"}>
              <FontAwesomeIcon
                icon={faPlus}
                className=" rounded-lg text-xl p-1 mr-3 drop-shadow-lg bg-white hover:bg-white"
              />
            </Link>
          </div>
        </div>
